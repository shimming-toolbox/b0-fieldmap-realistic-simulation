...
def smoothing_procedure(main_volume_path, segmentation_path, output_path):
    ...
    try:
        ...
        print("Problem occured attempting islands operation, continue")
    ...
    print("Starting shrink margin operation")
    # Margin
    segmentEditorWidget.setActiveEffectByName("Margin")
    effect = segmentEditorWidget.activeEffect()
    effect.setParameter("MarginSizeMm", -2)
    effect.self().onApply()
    print("Finished shrink margin operation")
    ...
    print("Starting joint smoothing operation")
    # Smoothing
    segmentEditorWidget.setActiveEffectByName("Smoothing")
    effect = segmentEditorWidget.activeEffect()
    effect.setParameter("SmoothingMethod", "JOINT_TAUBIN")
    effect.setParameter("JointTaubinSmoothingFactor", 0.75)
    effect.self().onApply()
    print("Finished smoothing operation")
