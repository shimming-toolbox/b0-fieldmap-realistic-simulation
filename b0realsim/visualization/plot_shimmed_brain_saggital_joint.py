...
def main(bids_dir):
    ...
    plt.savefig("subject-mosaic-brain_unshimmed_sagittal_fixedslice-brainmasked_slicewise.png", dpi=1200)
    ...
    plt.savefig("subject-mosaic-brain_shimmed_sagittal_fixedslice-brainmasked_slicewise.png", dpi=1200)
